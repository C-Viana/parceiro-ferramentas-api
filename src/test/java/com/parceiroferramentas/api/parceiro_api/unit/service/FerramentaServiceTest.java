...
public class FerramentaServiceTest {
    ...
    @Test
    @DisplayName("Deve retornar todas quando tipo for vazio")
    ...
    @Test
    @DisplayName("Deve retornar todas quando tipo for nulo")
    ...
    @Test
    @DisplayName("Deve retornar todas quando tipo for apenas espaços")
    ...
    void cadastrarNovaFerramenta_comCamposObrigatoriosVazios() {
        Ferramenta novaFerramenta = CreateMockedData.getInstance().getSingleEntity();
    ...
    void atualizarFerramenta_comCamposVazios() {
        Ferramenta ferramentaAtualizada = CreateMockedData.getInstance().getSingleEntity();
    ...
    void apagarFerramenta_comIdValido() {
        Ferramenta ferramentaNova = CreateMockedData.getInstance().getSingleEntity();
